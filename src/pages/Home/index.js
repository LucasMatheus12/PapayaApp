...
function req(){
    fetch('https://papayaclassifier.onrender.com/predict', {
    method: 'POST',
    body: JSON.stringify({
        img: Clock,
        type: 'normal'
    ...
    .then((response) => response.json())
        .then((json) => console.log('entrei aqui:',json))
}
...
export default function Home( {navigation }){
    return <>
        <View style={estilos.contPag}>
            ...
            <TouchableOpacity style={estilos.caixa} onPress={() => req()}>                
                <Text style={estilos.titleBox}>Requisicao</Text>
            </TouchableOpacity>
